                ...
                <div className="container px-5 py-16 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img
                            ...
                            src="https://m.media-amazon.com/images/I/617SeVMP15L._AC_UL480_QL65_.jpg"
                        />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">Levi's</h2>
                            ...
                            <div className="flex">
                                <span className="title-font font-medium text-2xl text-gray-900">₹799.00</span>
                                ...
                                <button onClick={() => { addToCart(slug, 1, 799, 'Wear the Code(XL,Red)', 'XL', "Red") }} className="flex ml-8 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">
                                    Add to Cart
                                </button>
                                <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4 hover:text-pink-500">
                                    <svg
                                        fill="currentColor"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                            ...
                            <div className="pin mt-6 flex space-x-2 text-sm">
                                ...
                                <button onClick={checkServiceability} className="flex ml-14 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">
                                    Check
                                </button>
                            </div>
                            {!service && <div className="text-red-700 text-sm mt-3">
                                Sorry! We do not deliver to this pincode yet.
                            </div>}
                            {service && service != null && <div className="text-green-700 text-sm mt-3">
                                Yay! This pincode is Available.
                            </div>}
                        </div>
                    </div>
                </div>
