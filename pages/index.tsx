  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description" content="CodeWare.com- ware the code" />
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the code as your armor, for in the digital realm, your ideas become your sword and your software, your shield.</p>
          </div>
      ...
      {/* <h1 className='text-3xl text-center font-bold'>Welcome to Codeware!</h1> */}
      <footer className="flex justify-between items-center py-0 px-6 bg-gray-800"></footer>
